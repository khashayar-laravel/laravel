        ...
        <section class="md:col-span-3">
            <div class="rounded-lg shadow-md bg-white p-3">
                <div class="flex justify-between items-center">
                    <a class="block p-4 text-blue-700" href="{{route('job.index')}}">
            ...
            <div class="container mx-auto p-4">
                ...
                @auth
                    ...
                    <div x-data="{ open: false }" id="applicant-form">
                        ...
                        <div x-click x-show="open" class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
                            <div @click.away="open = false" class="bg-white p-6 rounded-lg shadow-md w-full max-w-md">
                                ...
                                <form method="POST" action="{{route("applicant.store",$job->id)}}" enctype="multipart/form-data">
                                    ...
                                    <x-inputs.textaria id="message" name="message" label="Message" />
